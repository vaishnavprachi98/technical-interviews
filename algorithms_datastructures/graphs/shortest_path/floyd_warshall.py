...
def floyd_warshall(graph):  # O(V^3)
    ...
    for edge in graph.get_all_edges():  # graph is a directed.
    ...
    for k in range(num_nodes):
        ...
        for i in range(num_nodes):
            ...
            for j in range(num_nodes):
                ...
                # if distances[i][j] == math.inf:  # No path from node i to j, can't get to j.
                #     continue
                # if distances[i][k] == math.inf:  # No path from node i to k, no point going to k to get from i to j.
                #     continue
